...
// https://github.com/alainbryden/bitburner-scripts/blob/main/helpers.js
...
export async function runCommand_Custom(ns, fnRun, command, fileName, verbose = false, maxRetries = 5, retryDelayMs = 50, ...args) {
    ...
    let script = `import { formatMoney, formatNumberShort, formatDuration, parseShortNumber, scanAllServers } fr` + `om '${getFilePath('utils/helpers.js')}'\n` +
